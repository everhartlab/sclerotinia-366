...
## 
##            Df    AIC      F Pr(>F)   
## - Severity  1 1798.0 1.2191  0.025 * 
...
## 
##            Df    AIC      F Pr(>F)   
## - Severity  1 1818.7 1.1541  0.045 * 
...
## + Source 21 1835.5 1.0018  0.510   
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Step: bdist ~ Year + Severity + Region + Host + MCG 
## 
##            Df    AIC      F Pr(>F)   
## - Severity  1 1856.8 1.0071  0.405   
...
## + Severity  1 1857.1 1.0071  0.515
```
...
## 
##            Df    AIC      F Pr(>F)   
## - Severity  1 1935.3 1.1830  0.045 * 
...
## 
##            Df    AIC      F Pr(>F)   
## - Severity  1 1954.5 1.0222  0.315   
...
## + Host     24 1972.3 1.0516  0.030 * 
## + Severity  1 1955.3 1.0222  0.305   
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
...
## + Severity  1 1996.4 0.9414  0.805
```
