...
```{r mlg accumulation calculation}
...
```{r mlg accumulation noclump, fig.width = 5, fig.height = 3}
...
```{r mlg accumulation mlg, fig.width = 5, fig.height = 3}
...
```{r mlg accumulation uniq, fig.width = 5, fig.height = 3}
...
```{r mlg accumulation ten, fig.width = 5, fig.height = 3}
...
```{r mlg accumulation observed, fig.width = 5, fig.height = 3}
