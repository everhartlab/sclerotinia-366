...
The foundation of the discussion is well built.
Missing, however, is a synthesis of the information within each paragraph,
connecting it from one section to the next. I suggest you move the paragraph on
MCGs to the last (prior to limitations) and then delete all the sub-headings
(keep limitations and conclusions sub-headers).

I would also like to see more direct discussion of how the pouplation genetic
can be interpreted epidemiologically. For some guidance here, I suggest
revisiting Milgroom and Peever 2003 (10.1094/PDIS.2003.87.6.608).

I also suggest supporting epidemiological interpretations with conclusions that
other *S. sclerotiorum* population have shown. You've done an excellent job 
using the broader *S. sclerotiorum* literature to support your claims without
re-hashing the results. I think picking a couple of examples to highlight to
compare and contrast with the current results would be helpful to readers.
-->
...
Aggressiveness and specific source field had little to no effect on prediction of genetic diversity. 
...
Thus, we observed a shift in aggressiveness without a significant shift in genotypic structure, which may indicate that aggressiveness may be controlled by environmental factors as opposed to genetics.

<!-- ## Mycelial Compatibility Groups and Multilocus Haplotypes {-} -->

Mycelial Compatibility Groups have historically been used as a proxy for clonal lineages, and thus, of interest in this study was testing the association between multilocus haplotypes (MLHs) and mycelial compatibility groups (MCGs) [@leslie1993fungal; @otto-hanson2011variation; @kohn1990mycelial; @schafer2006optimized; @kohn1995clonal; @carbone1999patterns]. 
...
Perhaps add some discussion of independently evolving vegetatively compatible
lineages. 
-->
