...
All data processing and analyses were performed in a Rocker "verse" project container running `r R.version.string %>% strsplit("\\(") %>% map_chr(1)`[@boettiger2017introduction; @R] and are openly available and reproducible at https://github.com/everhartlab/sclerotinia-366/.
...
We would also like to thank Denita Hadziabdic and two anonymous reviewers for their valuable comments and insights that improved the quality of the manuscript.
