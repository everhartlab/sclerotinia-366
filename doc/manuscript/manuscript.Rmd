...
We assessed genotypic diversity by calculating Stoddart and Taylor's index (*G*) [@stoddart1988genotypic], Shannon's index (*H*) [@shannon2001mathematical], Simpson's index ($\lambda$) [@simpson1949measurement], and evenness ($E_5$, *eMLH*) [@heck1975explicit; @hurlbert1971nonconcept; @pielou1975ecological; @grunwald2003analysis]. 
...
Each edge represented a single MLH, but because a single MLH could be present in more than one population, that MLH would be represented by (*n*\*(*n*-1))/2 edges where n represents the number of populations crossed.
